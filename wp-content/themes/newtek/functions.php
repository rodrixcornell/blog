...
function newtek_load_styles() {
if (!is_admin()) {
wp_register_style('googleFont', 'http://fonts.googleapis.com/css?family=Open+Sans');
wp_enqueue_style( 'newtek-style', get_stylesheet_uri(), array('googleFont') ); }
}

add_action( 'wp_enqueue_scripts', 'newtek_load_styles' );
